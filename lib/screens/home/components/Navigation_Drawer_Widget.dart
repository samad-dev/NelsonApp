...
class _NavigationDrawerWidget extends State<NavigationDrawerWidget> {
  ...
  getUserRoutes() async {
    ...
    var VarRequest = http.Request(
        'GET',
        Uri.parse(
            'http://151.106.17.246:8080/nelson-paints-web/api/get/user_routes.php'));
    http.StreamedResponse VarResponse = await VarRequest.send();
  ...
  getRoutes() async {
    ...
    var VarRequest = http.Request(
        'GET',
        Uri.parse(
            'http://151.106.17.246:8080/nelson-paints-web/api/get/routes.php'));
    http.StreamedResponse VarResponse = await VarRequest.send();
  ...
  getp() async {
    ...
    var request = http.Request(
        'GET',
        Uri.parse(
            'http://151.106.17.246:8080/nelson-paints-web/api/get/products.php'));
    http.StreamedResponse response = await request.send();
    if (response.statusCode == 200) {
      String data = await response.stream.bytesToString();
